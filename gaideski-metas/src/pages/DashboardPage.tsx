    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          ...
          { label: 'Líder Atual',          value: ranking[0]?.employeeName ?? '–',                                      icon: Trophy,    color: 'text-amber-400' },
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              ...
              {!isLoading && ranking.length === 0 && (
                <tr><td colSpan={14} className="text-center py-12 text-muted-foreground">Nenhum dado ainda.</td></tr>
              )}
              {ranking.map((row, i) => (
